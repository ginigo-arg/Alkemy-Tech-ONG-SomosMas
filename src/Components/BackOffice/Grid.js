...
const BackofficeGrid = () => {
  return (
    <Container style={{ display: 'grid', minHeight: 'calc(100vh - 60px)', placeItems: 'center' }}>
      <Container style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(400px, 1fr))', gap: '35px' }}>
        ...
        <Link to="/backoffice/activities" style={{ width: '100%', padding: '20px', borderRadius: '5px', gap: '10px', boxShadow: '0 -1px 15px #ededed', display: 'grid', placeItems: 'center' }}>
        ...
        <Link to="/backoffice/organization" style={{ width: '100%', padding: '20px', borderRadius: '5px', gap: '10px', boxShadow: '0 -1px 15px #ededed', display: 'grid', placeItems: 'center' }}>
        ...
        <Link to="/backoffice/slides" style={{ width: '100%', padding: '20px', borderRadius: '5px', gap: '10px', boxShadow: '0 -1px 15px #ededed', display: 'grid', placeItems: 'center' }}>
        ...
        <Link to="/backoffice/users" style={{ width: '100%', padding: '20px', borderRadius: '5px', gap: '10px', boxShadow: '0 -1px 15px #ededed', display: 'grid', placeItems: 'center' }}>
        ...
        <Link to="/backoffice/members" style={{ width: '100%', padding: '20px', borderRadius: '5px', gap: '10px', boxShadow: '0 -1px 15px #ededed', display: 'grid', placeItems: 'center' }} >
